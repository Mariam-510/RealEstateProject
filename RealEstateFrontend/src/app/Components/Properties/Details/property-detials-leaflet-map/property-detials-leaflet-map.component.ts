...
@Component({
  selector: 'app-property-detials-leaflet-map',
  imports: [CommonModule, HttpClientModule], // ✅ Import CommonModule and HttpClientModule
  templateUrl: './property-detials-leaflet-map.component.html',
  styleUrl: './property-detials-leaflet-map.component.css'
})
export class PropertyDetialsLeafletMapComponent {
  private map!: L.Map;
