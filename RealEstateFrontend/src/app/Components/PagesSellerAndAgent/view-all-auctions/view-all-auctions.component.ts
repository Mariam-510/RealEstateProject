...
@Component({
  ...
  styleUrl: './view-all-auctions.component.css'
})
...
// view-all-auctions.component.ts
  ...
  if (confirm('Are you sure you want to delete this auction?')) {
    this.auctionService.deleteAuction(id).subscribe({
      next: () => {
        ...
        this.filteredAuctions = this.filteredAuctions.filter(a => a.id !== id);
        this.updatePagination();
        
        // Success notification
        this.toastr.success('Auction deleted successfully!', 'Success');
      },
      error: (error) => {
        console.error('Delete failed:', error);
        
        // Error notification
        const errorMessage = error.error?.message || 'Failed to delete auction. Please try again.';
